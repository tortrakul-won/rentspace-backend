...
type RenterBookingDetailResponse struct {
	ID               string   `json:"id"`
	RefCode          string   `json:"ref_code"`
	SpaceID          string   `json:"space_id"`
	RenterID         string   `json:"renter_id"`
...
func renterBookingDetailToResponse(r store.RenterBookingDetailRow) RenterBookingDetailResponse {
	resp := RenterBookingDetailResponse{
		ID:               r.ID.String(),
		RefCode:          r.RefCode,
		SpaceID:          r.SpaceID.String(),
		RenterID:         r.RenterID.String(),
